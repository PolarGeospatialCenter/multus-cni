...
},
{
  ...
  "namespace":"other-ns"
	...
	It("replaces local delegates with those from kubernetes when an annotation is present", func() {
		fakePod := testutils.NewFakePod("testpod", `[
{"name":"net1"},
{
  "name":"net3",
  "namespace":"other-ns"
	...
	"cniVersion": "0.2.0"
		...
		fNetConf := &types.NetConf{
			ReplaceWithKubeNetworks: true,
			RawDelegates: []map[string]interface{}{
